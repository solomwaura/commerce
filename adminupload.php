...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$image ='products/'.$_FILES['image']['name'];
    ...
    $price = $_POST['price'];
		...
		if (preg_match("!image!", $_FILES['image']['type'])) {
			if (copy($_FILES['image']['tmp_name'], $image)) {
				$sql = "INSERT INTO products(pname,category,price,image) VALUES ('$pname','$category','$price','$image')";
...
<div class="col-md-1">
  ...
  <div class="col-md-5">
    <h3>Uploading Image Products:</h3>
