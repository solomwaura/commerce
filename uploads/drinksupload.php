...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$image ='drinks/'.$_FILES['image']['name'];
    ...
    $price = $_POST['price'];
		...
		if (preg_match("!image!", $_FILES['image']['type'])) {
			if (copy($_FILES['image']['tmp_name'], $image)) {
				$sql = "INSERT INTO drinks(pname,price,image) VALUES ('$pname','$price','$image')";
...
<div class="col-md-3">
  ...
  <div class="col-md-6">
  <form action="drinksupload.php" method="POST" enctype="multipart/form-data">
  <label>Name:</label>
