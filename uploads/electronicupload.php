...
<?php
	...
	if (isset($_POST['submit'])) {
		...
		$image ='electronics/'.$_FILES['image']['name'];
    ...
    $price = $_POST['price'];
		...
		if (preg_match("!image!", $_FILES['image']['type'])) {
			if (copy($_FILES['image']['tmp_name'], $image)) {
				$sql = "INSERT INTO electronics(pname,price,image) VALUES ('$pname','$price','$image')";
...
<div class="col-md-3">
  ...
  <div class="col-md-6">
  <form action="electronicupload.php" method="POST" enctype="multipart/form-data">
  <label>Name:</label>
